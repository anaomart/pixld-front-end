...
const randomImage =
  "https://source.unsplash.com/1600x900/?technology,phtograpy,nature";
export default function UserProfile() {
  const { user, pins, saved, createdPins, setSaved, setCreatedPins } =
        ...
        <div className="relative flex flex-col mb-7">
          <div className="flex flex-col justify-center items-center">
            ...
            <img
              ...
              alt="profile"
            />
            <h1 className="font-bold text-3xl text-center mt-2">{user.name}</h1>
